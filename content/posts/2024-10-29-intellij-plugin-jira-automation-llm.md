...
반복적인 Jira 티켓 작성이 귀찮았다. 코드를 수정하고, 변경 내용을 정리하고, Jira에 들어가서 티켓을 만들고... 이 과정을 자동화하고 싶었다.

## 문제 정의

개발자의 일상적인 워크플로우를 보면 이렇다.
...
3~4번이 특히 번거롭다. 변경 내용을 보면서 "이걸 어떻게 설명하지?"를 고민하고, Jira 웹 UI에서 폼을 채우는 시간이 아깝다.
