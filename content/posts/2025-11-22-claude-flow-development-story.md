...
복잡한 인프라도 `./start.sh` 하나로 시작할 수 있어야 한다. 이 원칙이 전체 설계를 관통한다.
...
| 포스트 | 핵심 내용 |
|--------|----------|
| [엔터프라이즈 AI 에이전트 플랫폼 설계기](/dev-notes/posts/2025-12-28-claude-flow-ai-agent-platform/) | 원커맨드 시작, 장애 자동화, 서브에이전트, API 설계 |
